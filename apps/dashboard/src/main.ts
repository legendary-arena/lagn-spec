...
// tooltip, legend) and a renderer are registered here at startup. `LegendComponent`
// backs `SweepTrendChart.vue`'s daily/weekly series legend — without it ECharts
// logs "Component legend is used but not imported" on /pipeline and drops the legend.
useECharts([CanvasRenderer, LineChart, BarChart, GridComponent, TooltipComponent, LegendComponent]);
